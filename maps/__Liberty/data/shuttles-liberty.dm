...
/datum/shuttle/autodock/multi/vasiliy
	...
	destination_tags = list("nav_vasiliy_homebase", "nav_vasiliy_deep_forest", "nav_vasiliy_swamps", "nav_vasiliy_river_forest", "nav_brige_outpost") //, "nav_vasiliy_spacefort"
