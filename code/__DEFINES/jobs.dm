...
#define JOBS_ANTI_HIVEMIND "Deputy Chief","Armorer","Criminal Investigator","Sentry","Watchmen","Prime","Vector","Field Shepherd","Trapper","Shipbreaker","Premier","Steward","AI","Janitor","Paramedic","PIRS Roboticist","Mining Technician"
