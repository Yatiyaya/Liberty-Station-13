...
/datum/controller/subsystem/supply/stat_entry()
	..("Credits: [get_account_credits(department_accounts[DEPARTMENT_SERVICE])]")
...
/datum/controller/subsystem/supply/proc/sell()
	...
	var/datum/transaction/T = new(points, "Skylight Syndicate", "Exports", "Skylight Automated Trading System")
	T.apply_to(GA)
