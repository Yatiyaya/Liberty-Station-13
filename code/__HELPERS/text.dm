...
/proc/pencode2html(t)
	...
	t = replacetext(t, "\[liberty\]", "<img src = liberty.png>")
	t = replacetext(t, "\[watchlogo\]", "<img src = watch.png>")
	t = replacetext(t, "\[bonfireseal\]", "<img src = bonfire.png>")
	t = replacetext(t, "\[capsalogo\]", "<img src = capsa.png>")
	t = replacetext(t, "\[pirslogo\]", "<img src = pirs.png>")
	t = replacetext(t, "\[fontaine\]", "<img src = fontaine.png>")
	t = replacetext(t, "\[terralogo\]", "<img src = terratherma.png>")
	t = replacetext(t, "\[syndie\]", "<img src = skylight.png>")
	t = replacetext(t, "\[cult\]", "<img src = talisman.png>")
