/obj/machinery/power/port_gen/os_generator
	...
	desc = "A Simulacrum Robotics portable fusion microgenerator rather complicated and hard to use on top of needing a certification to operate one quickly led to only inhouse use rather than market success."
