...
/datum/unit_test/area_contents/Run()
	var/static/list/exempt_areas = typesof(
		...
		/area/turbolift, /area/mine, /area/asteroid, /area/liberty/quartermaster/underground_to_surface_disposal,
		/area/liberty/quartermaster/mining_outside_doc,
		/area/colony, /area/liberty/dungeon, /area/liberty/outside)

	var/static/list/exempt_from_atmos = typesof(
		/area/eris/maintenance, /area/eris/storage,
		/area/eris/engineering/atmos/storage,
		/area/eris/engineering/construction, /area/liberty/quartermaster/underground_to_surface_disposal,
		/area/eris/rnd/server, /area/mine, /area/asteroid,
		/area/liberty/quartermaster/mining_outside_doc,
		/area/colony, /area/liberty/dungeon, /area/liberty/outside,
		/area/liberty/crew_quarters/hydroponics/garden, /area/liberty/pros/shuttle,
	...
	var/static/list/exempt_from_apc = typesof(
		...
		/area/eris/medical/genetics, /area/liberty/quartermaster/underground_to_surface_disposal,
