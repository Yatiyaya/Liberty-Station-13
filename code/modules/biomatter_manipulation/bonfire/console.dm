...
/obj/machinery/multistructure/bonfire_part/console
	...
	desc = "A console that measures liquid scorch inside of the Bonfire platforms and tank, as well as detecting clogged pipes."
	icon_state = "screen"
	layer = ABOVE_MOB_LAYER + 0.1
	idle_power_usage = 350

/obj/machinery/multistructure/bonfire_part/console/Initialize()
	. = ..()
	set_light(1, 2, COLOR_LIGHTING_BLUE_MACHINERY)


/obj/machinery/multistructure/bonfire_part/console/attack_hand(mob/user as mob)
	if(MS)
		nano_ui_interact(user)


/obj/machinery/multistructure/bonfire_part/console/nano_ui_data()
	var/list/data = list()
...
/obj/machinery/multistructure/bonfire_part/console/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = NANOUI_FOCUS, datum/nano_topic_state/state = GLOB.default_state)
