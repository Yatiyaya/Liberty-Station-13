...
/obj/item/gun/energy/plasma/cassad/cult
	...
	outside the Phokorus Institute or Church. Perhaps its popularity is what imprinted it in the memory of the psion that made it?"
...
/obj/item/gun/energy/plasma/auretian/cult
	...
	desc = "An energy weapon forged from the mind of a psion who shaped an oddity into a weapon. The iconic auretian is a weapon that the Phokorus Institute employs often and frequently among its staff, \
...
/obj/item/gun/energy/plasma/auretian/cult/deepmaints
	...
	desc = "An energy-styled handgun willed into reality from the mind of someone looking to improve just about everything about it. Whether they meant to or not, they made a perfected copy of the PI Auretian."
	icon = 'icons/obj/guns/energy/psi_brigador.dmi'
	icon_state = "brigador"
	origin_tech = list()
	matter = list()
