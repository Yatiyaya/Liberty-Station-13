...
/obj/item/gun/energy/plasma/cassad/cult
	...
	outside the CAPSA or Church. Perhaps its popularity is what imprinted it in the memory of the psion that made it?"
...
/obj/item/gun/energy/plasma/auretian/cult
	...
	desc = "An energy weapon forged from the mind of a psion who shaped an oddity into a weapon. The iconic auretian is a weapon that the CAPSA employs often and frequently among its staff, \
