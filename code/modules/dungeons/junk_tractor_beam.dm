...
/obj/structure/jtb_pillar
	...
	While stable, it is not quite fully understood, being the product of Soteria's captured Similacrum Positronics AI, Brynn. For an unknown reason, the pylons only work in the presence of obelisks."
