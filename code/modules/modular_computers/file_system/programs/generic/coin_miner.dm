/datum/computer_file/program/coin_miner
	...
	extended_desc = "A endlessly compressed file that when processed turns into valueable credit on the non-terran market. The bigger the file, the more its worth."
	size = 1
