/datum/conback_module/prosthetic_debug
...
/datum/conback_module/prosthetic_debug/activate(mob/user)
...
/datum/conback_module/prosthetic_debug/proc/give_results(var/organ_name, var/dmg_message, var/has_damage)
	var/warning
	if(has_damage)
		warning = MESSAGE_WARNING
	message_user("[organ_name]: [dmg_message]", warning)

/datum/conback_module/prosthetic_debug/stat_text()
