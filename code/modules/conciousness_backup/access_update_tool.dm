/obj/item/weapon/access_update_tool
	...
	var/obj/item/item/card/id/card //Our current ID card. We copy access from this.
...
/obj/item/weapon/access_update_tool/afterattack(atom/A, mob/living/user)
	if(istype(A, /mob/living/carbon/human))
		...
		var/obj/item/weapon/implant/conback/conciousness_pres = person.conciousness_pres
