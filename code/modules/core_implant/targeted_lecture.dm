...
/datum/lecture/targeted
	name = "targeted ritual"
	desc = "Basic ritual that does nothing."
	phrase = null

/datum/lecture/targeted/get_say_phrase()
	if(!phrase || phrase == "")
		return
...
/datum/lecture/targeted/get_display_phrase()
	return phrase

/datum/lecture/targeted/compare(var/text)
	if(!phrase || phrase == "")
		return
...
/datum/lecture/targeted/get_targets(var/text)
	var/regex/R = regex("[TARGET_PATTERN]","g")
...
/datum/lecture/targeted/proc/process_target(var/index, var/obj/item/implant/core_implant/target, var/text)
	return TRUE
