...
/datum/maps_data
	...
	var/allowed_jobs = list(/datum/job/premier, /datum/job/rp, /datum/job/pg, /datum/job/cso, /datum/job/chief_engineer, /datum/job/clubmanager, /datum/job/smc, /datum/job/swo, /datum/job/foreman,
