/datum/computer_file/program/cook_catalog
	...
	filedesc = "VIKA"
	extended_desc = "Lonestar (and CAPSA) Presents: Victoria's Incredible Kitchen Assistant - an AI-generated electronic catalog for cooking."
...
/datum/nano_module/cook_catalog
	name = "Lonestar (and CAPSA) Presents: Victoria's Incredible Kitchen Assistant"
