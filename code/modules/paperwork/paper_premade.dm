...
/obj/item/paper/laber_camp_notice
	...
	info = {"From Terra-Therma Worker's Union and Phokorus Institute Xenoarch Division:
	<BR>\n\tTerra-Therma Worker's Union:
	<BR>\n\t\tDue to LSS mining operations and Phokorus Institute Toxin testing the labor camp might have rock falls refilling the area from time to time.
	<BR>\n\t\tWith this issue ever present, we are unable to add any power networking down into the camp.
	<BR>\n
	<BR>\n\Phokorus Institute Xenoarch Division:
