...
/obj/item/reagent_containers/food/snacks/openable/candy/os
	desc = "SD branded non-melting chocolate."
	alt_desc = "SD branded non-melting chocolate. This one is open, and still unmelted."
...
/obj/item/reagent_containers/food/snacks/openable/candy/os/Initialize(mapload)
	...
	"chocolate" = 1)))
		...
		if("chocolate_milk")
			desc = "SD branded non-melting chocolate. This one has been enhanced with extra milk."
			alt_desc = "SD branded non-melting chocolate. This one has been enhanced with extra milk. This one is open, and still unmelted."
		...
		if("chocolate_grape")
			desc = "SD branded non-melting chocolate. This one sports a grape flavour."
			alt_desc = "SD branded non-melting chocolate. This one sports a grape flavour. This one is open, and still unmelted."
		...
		if("chocolate_chestnut")
			desc = "SD branded non-melting chocolate. This one warns of chestnuts being added into the bar."
			alt_desc = "SD branded non-melting chocolate. This one warns of chestnuts being added into the bar. This one is open, and still unmelted."
		...
		if("chocolate_bitter")
			desc = "SD branded non-melting chocolate. This one has coffee added in making it bitter."
			alt_desc = "SD branded non-melting chocolate. This one has coffee added in making it bitter. This one is open, and still unmelted."
		...
		if("chocolate_fruit")
			desc = "SD branded non-melting chocolate, mixed with berry flavours."
			alt_desc = "SD branded non-melting chocolate, mixed with berry flavours. This one is open, and still unmelted."
		...
		if("chocolate_almond")
			desc = "SD branded non-melting chocolate. This one warns of almond being added into the bar."
			alt_desc = "SD branded non-melting chocolate. This one warns of almond being added into the bar. This one is open, and still unmelted."
...
/obj/item/reagent_containers/food/snacks/openable/os_soypack
	name = "SD portable SoyPack."
	desc = "SD portable SoyPack."
	alt_desc = "SD portable SoyPack."
...
/obj/item/reagent_containers/food/snacks/openable/os_soypack/Initialize(mapload)
	...
	"soylent_vanilla" = 1)))
		...
		if("soylent_orange")
			desc = "A SD SoyPack, this one has added orange flavour."
			alt_desc = "A SD SoyPack, this one has added orange flavour. The smell of oranges is rather faint..."
			icon_state = "soylent_orange"
		...
		if("soylent_fish")
			desc = "A SD SoyPack, this one has added shellfish flavours."
			alt_desc = "A SD SoyPack, this one has added shellfish flavour. The smell of rotton fish reaks from the cap."
		...
		if("soylent_strawberry")
			desc = "A SD SoyPack, this one has added strawberry flavouring."
			alt_desc = "A SD SoyPack, this one has added strawberry flavour. A sickenly sweet smell lingers from the cap."
		...
		if("soylent_apple")
			desc = "A SD SoyPack, this one has added green apple flavouring."
			alt_desc = "A SD SoyPack, this one has added green apple flavour. The smell of cinnamon is stronger then apple..."
		...
		if("soylent_grape")
			desc = "A SD SoyPack, this one has added red grape flavouring."
			alt_desc = "A SD SoyPack, this one has added grape flavour. Shockingly has no smell."
		...
		if("soylent_vanilla")
			desc = "A SD SoyPack, the most basic packet."
			alt_desc = "A SD SoyPack this one being the basic vanilla but it has no smell of vanilla!"
