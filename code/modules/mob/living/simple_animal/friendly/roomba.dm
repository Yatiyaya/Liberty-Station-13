/mob/living/simple_animal/pirs_roomba
	name = "7K-Ten"
	desc = "A pink roomba, the Research Provost's pet."
...
/mob/living/simple_animal/pirs_roomba/attackby(obj/item/W as obj, mob/user as mob)
...
/mob/living/simple_animal/pirs_roomba/death()
	..()
