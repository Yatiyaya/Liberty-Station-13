...
/mob/living/carbon/superior_animal/handmade/mantis
	...
	desc = "Built from the Phokorus Institute robotics division's craftsmanship, and gathered designs of Greyson positronics, each of these fully robotic automatons is a unique, handmade, heavily armored assembly."
	icon_state = "pi_mantis_handmade"
