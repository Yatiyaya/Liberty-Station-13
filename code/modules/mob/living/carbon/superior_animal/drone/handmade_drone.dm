/mob/living/carbon/superior_animal/handmade
	...
	desc = "Built from the Soteria robotics division's craftsmanship, and gathered designs of Similacrum positronics, each of these fully robotic automatons is a unique, handmade, heavily armored assembly."
