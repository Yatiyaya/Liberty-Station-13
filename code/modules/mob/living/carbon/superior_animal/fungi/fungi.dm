/mob/living/carbon/superior_animal/fungi
	name = "strange fungi"
	desc = "Is that a mushroom? Maybe it escaped from the Phokorus Institute labs? It certainly doesn't look like the usual walking mushrooms one would see in xenoflora."
	faction = "neutral"
