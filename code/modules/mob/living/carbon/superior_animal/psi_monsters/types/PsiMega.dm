/mob/living/carbon/superior_animal/psi_monster/dreaming_king
	name = "Dreaming King"
	desc = "The Dreaming King, named by the first psion who saw it through a drug induced haze. Thought first to be merely the creation of a fever dream until libertys into deep maintenance revealed him \
	...
	natural_weapon = /obj/item/natural_weapon/psi_monster/Dreaming
