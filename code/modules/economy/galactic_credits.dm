...
/obj/item/stack/gal_cred
	...
	desc = "The most common currency used around the galaxy, accepted by most traders. Most.. Pallas traders tend to not like taking these. At least they hold their value better than corporate scrip or coalition credit."
	icon = 'icons/obj/spacebucks.dmi'
	icon_state = "cred"
