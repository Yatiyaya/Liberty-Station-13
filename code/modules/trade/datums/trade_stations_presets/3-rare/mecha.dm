/datum/trade_station/mechas
	name_pool = list("AKTCS 'Junker'" = "Astrakhan Tankograd Company Shuttle 'Junker'. Seems that they construct and sell are exosuit parts. Sensors showing that they have a roving vessel, maybe they have one last batch for sale.\
