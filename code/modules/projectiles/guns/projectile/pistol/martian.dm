/obj/item/gun/projectile/martian
	...
	gun_parts = list(/obj/item/part/gun/frame/martian = 1, /obj/item/part/gun/grip/rubber = 1, /obj/item/part/gun/mechanism/pistol = 1, /obj/item/part/gun/barrel/kurtz = 1)
