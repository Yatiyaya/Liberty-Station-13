...
/obj/item/gun/projectile/colt/liberty
	...
	desc = "A common Liberty Marshal issue pistol chambered in 10mm Magnum. It appears to be loosely based off a Colt model, albeit with a changed slide, polymer grip and a built-in holographic sight."
