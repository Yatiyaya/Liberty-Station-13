/obj/item/gun/energy/laser/railgun/pistol/slab
	...
	desc = "A variation upon the Guild's famous \"Myrmidon\" rail pistol, this weapon uses a minaturised fusion reactor based on Similacrum Positronics schematics to collect microscopic amounts of scrap from the air \
