...
/datum/technology/GP_armor
	...
	desc = "SD Laser resistant armor vests that were supplied and branded as Iron Lock, the bases of all other laser armor."
	tech_type = RESEARCH_GREYSON
...
/datum/technology/GP_stockparts
	...
	desc = "SD Manipulator, Laser, Matter Bin, Scanner and Capacitor"
	tech_type = RESEARCH_GREYSON
...
/datum/technology/GP_nano_toolmods
	...
	desc = "SD pre-programed self replicating nanites to fit onto any ."
	tech_type = RESEARCH_GREYSON
