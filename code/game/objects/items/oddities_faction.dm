...
/obj/item/biosyphon
	...
	desc = "An exceedingly rare bluespace anomaly discovered by a marshal ranger outside the colony. After weeks of study it was determined its only purpose was duplicating boxes of donuts. CAPSA's disappointment was so great they gave the item to security for safe keeping. Months after its discovery it began to create refined cases of incredibly tasty donuts filled with long-lasting effective stimulants every two hours."
...
/obj/item/device/von_krabin
	...
	desc = "A strange anomalous item given to the research directors of CAPSA as its latent effects enhance the mind. Some say this is an unfinished prototype of the technology the church of absolute uses to enhance the abilities of others."
	icon = 'icons/obj/device.dmi'
