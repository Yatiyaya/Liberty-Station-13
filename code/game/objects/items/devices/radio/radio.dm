...
var/global/list/default_internal_channels = list(
	...
	num2text(NT_FREQ) = list(access_bonfire_disciple),
	...
	num2text(PRO_FREQ) = list(access_fontaine),
...
/obj/item/device/radio/random_radio
	...
	canhear_range = 4
	var/random_hear = 20
	channels = list("Board" = 1, "Watch" = 1, "Terra" = 1, "Custodians" = 1, "PIRS" = 1, "CAPSA" = 1, "Skylight" = 1, "AI Private" = 1, "Fontaine" = 1)
	price_tag = 20000
