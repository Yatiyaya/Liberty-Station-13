/obj/item/organ_module/active/simple/surgical
	...
	desc = "An all-in-one medical tool implant based on the legendary Simulacrum Robotics model. While convenient, it is less efficient than more advanced surgical tools, such as laser scalpels, and requires a power cell."
