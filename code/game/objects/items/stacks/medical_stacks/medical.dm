/obj/item/stack/medical
	...
	var/heal_burn = 0
	price_tag = 10
	matter = list(MATERIAL_BIOMATTER = 1) // This is amount of matter PER SHEET, remember this for balance purposes as this value will become quintuple on full stacks.
