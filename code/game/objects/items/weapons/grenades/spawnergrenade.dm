...
/obj/item/grenade/spawnergrenade/manhacks/junkbot
	...
	desc = "A shitty rapid 'build-a-bot' grenade produced by prospector salvagers using designs 'borrowed' from the CAPSA, handy for a build-a-bot guard or as a disposable decoy."
	deliveryamt = 1
	icon_state = "screamer"
