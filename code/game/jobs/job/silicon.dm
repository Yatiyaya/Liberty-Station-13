/datum/job/ai
	...
	supervisors = "your laws and the CAPSA Research Overseer"
	...
	The usual CAPSA law set is to serve the public trust, protect the innocent, and prevent tampering. Keep them in mind constantly.<br>\
