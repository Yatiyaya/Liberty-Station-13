/datum/job/rp
	...
	description = "The Research Provost is the head of the research branch of the CAPSA, directing science activities.<br>\
...
/datum/job/scientist
	...
	description = "The Scientist is a researcher representing the CAPSA, standing at the frontier of human advancement.<br>\
	...
	The manufacture of high tech devices is the primary source of income for CAPSA, but artifacts and alien life may offer great potential.<br>\
...
/datum/job/roboticist
	...
	description = "The Roboticist is a specialized scientist with a busy workload - at the forefront of CAPSA's service offerings.<br>\
