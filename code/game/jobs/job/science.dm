/datum/job/rp
	...
	perks = list(PERK_SURGICAL_MASTER, PERK_ROBOTICS_EXPERT, PERK_SCIENCE, PERK_CHEMIST)
	...
	description = "The Research Provost is the head of the surface section of the Phokorus Institute, directing science activities.<br>\
...
/datum/job/scientist
	...
	perks = list(PERK_SCIENCE, PERK_CHEMIST) //We do hydro?
