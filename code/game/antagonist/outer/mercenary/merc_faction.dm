#define WELCOME_SERBS "You are a void wolf, part of a team of professional smugglers and mercenaries. You are currently aboard your base preparing for a mission targeting the Liberty Colony.<br>\
	<br>\
