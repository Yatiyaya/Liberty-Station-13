...
/obj/item/shield_projector/rectangle/church_personal
	...
	description_info = "A personal shield designed by the church to rival the CAPSA shields, though it is weaker than most CAPSA shields it none the less provides extra protection, \
