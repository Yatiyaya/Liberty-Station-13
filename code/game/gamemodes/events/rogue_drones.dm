...
/datum/event/rogue_drone/setup()
	...
	var/area/spess = locate(/area/liberty/outside/forest) in world
...
/datum/event/rogue_drone/end()
	...
	if(num_recovered > drones_list.len * 0.75)
		command_announcement.Announce("CAPSA drone control reports the malfunctioning wing has been recovered safely.", "Rogue drone alert")
	else
		command_announcement.Announce("CAPSA drone control registers disappointment at the loss of the drones, but the survivors have been recovered.", "Rogue drone alert")
