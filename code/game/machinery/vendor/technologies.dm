...
/obj/machinery/vending/build_a_drone
	...
	desc = "A vendor selling customized drones for a hefty price. All profits goes to the CAPSA."
	icon_state = "wallresearch"
	density = FALSE
	products = list(/obj/item/build_a_drone_kit = 20)
	auto_price = TRUE
	vendor_department = DEPARTMENT_SCIENCE // CAPSA get paid for the drones

/obj/item/build_a_drone_kit
	name = "build-a-drone kit"
	desc = "A self-assembling Build-A-Drone kit designed by CAPSA's Robotic Division. No refunds."
