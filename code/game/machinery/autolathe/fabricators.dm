...
/obj/machinery/bulletfabricator
	...
	with rare or valuable materials having greater point values. Originally a scavenged design from the Similacrum Positronics repurposed by the Terra-Therma Union. \
