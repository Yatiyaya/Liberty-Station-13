...
Chemical Neutralizer - Reduces addiction chance all the way down to 0.1 and increases max NSA by flat 10 (solborn still negates these) | Incompatible with Drug Addict (PERK_ADDICT)
*/
