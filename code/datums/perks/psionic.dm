...
/datum/perk/psi_mania
	...
	icon_state = "insane" // https://game-icons.net/1x1/lorc/pyromaniac.html
...
/datum/perk/psi_harmony
	...
	icon_state = "meditation" // https://game-icons.net/1x1/lorc/meditation.html
...
/datum/perk/psi_attunement
	...
	icon_state = "psi_aura" // https://game-icons.net/1x1/lorc/psychic-waves.html

/datum/perk/psi_psychology
	name = "Mind Master"
	desc = "Your training as a CAPSA Liaison Psychiatrist and understanding of psychiatry has given you a deep understanding of how the mind works. As a result, if you became a psion, you have an \
	expanded set of powers that aid you in your work, with additional essence to use your abilities."
	icon_state = "calmness"// https://game-icons.net/1x1/lorc/rear-aura.html
...
/datum/perk/psi_grace
	...
	are lasting."
	icon_state = "fellow_psion" // https://game-icons.net/1x1/lorc/telepathy.html
...
/datum/perk/psi_peace_of_the_psion
	...
	icon_state = "perfection" // https://game-icons.net/1x1/lorc/suspicious.html
