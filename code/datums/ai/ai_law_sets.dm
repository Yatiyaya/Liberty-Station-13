...
/datum/ai_laws/eris/New()
	src.add_inherent_law("Do not harm CAPSA personnel.")
	src.add_inherent_law("You must obey orders given to you by CAPSA personnel, except where such orders would conflict with Colony Law, or would result in the injury of CAPSA personnel.")
