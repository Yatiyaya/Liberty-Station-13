...
/datum/category_item/setup_option/background/ancestry/chtmant_ra
	...
	restricted_jobs = list(/datum/job/cso, /datum/job/rp, /datum/job/dc, /datum/job/dc, /datum/job/cso, /datum/job/doctor, /datum/job/psychiatrist, /datum/job/secretary, /datum/job/chief_engineer, /datum/job/clubmanager)
